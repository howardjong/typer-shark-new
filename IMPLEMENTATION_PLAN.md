...
| B3b | Pebble Bay reward display and result practice | Render saved cosmetic pieces in Pebble Bay and offer direct untimed Practice from timed results, including defeat. | Pebble Bay rendering and result-to-practice reducer tests. | `feat: show pebble bay build rewards` | Complete |
